...
if (!filter_var($user->email, FILTER_VALIDATE_EMAIL)) {
    ...
    if ($user->createUser()) {
            echo json_encode(array('status'=> 1, 'message' => 'Teacher created successfully!', 'data'=> array()));
        } else {
            echo json_encode(array('status'=> 0, 'message' => 'Teacher creation failed!', 'data'=> array()));
        }
    }
}
